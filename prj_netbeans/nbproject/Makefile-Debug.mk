...
${OBJECTDIR}/_ext/1360937237/Transform.o: ../src/Transform.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Transform.o ../src/Transform.cpp
...
${OBJECTDIR}/_ext/1360937237/Group.o: ../src/Group.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Group.o ../src/Group.cpp

${OBJECTDIR}/_ext/1360937237/Camera.o: ../src/Camera.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Camera.o ../src/Camera.cpp
...
${OBJECTDIR}/_ext/1360937237/Material.o: ../src/Material.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Material.o ../src/Material.cpp
...
${OBJECTDIR}/_ext/1360937237/Light.o: ../src/Light.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Light.o ../src/Light.cpp

${OBJECTDIR}/_ext/1360937237/Scene.o: ../src/Scene.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Scene.o ../src/Scene.cpp

${OBJECTDIR}/_ext/1360937237/Cube.o: ../src/Cube.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Cube.o ../src/Cube.cpp
